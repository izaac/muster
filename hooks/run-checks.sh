...
scripts=(muster install.sh lib/*.sh drivers/*.sh docker/*.sh hooks/*.sh hooks/pre-commit hooks/pre-push examples/*/*.sh)
...
echo "hook: shfmt"
shfmt -d -i 2 -ci -bn muster install.sh lib drivers docker/*.sh hooks examples/*/*.sh
