...
scripts=(muster lib/*.sh drivers/*.sh docker/*.sh hooks/*.sh hooks/pre-commit hooks/pre-push examples/*/*.sh)
...
echo "hook: shfmt"
shfmt -d -i 2 -ci -bn muster lib drivers docker/*.sh hooks examples/*/*.sh
